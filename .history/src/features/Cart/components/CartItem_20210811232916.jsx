...
function CartItem({ cartItem }) {
  ...
  const handleSubmit = (newQuantity, e) => {
    ...
    const qty = Number(product.quantity, newQty);
    console.log(newQuantity.quantity, qty);
          ...
          <Box className={classes.sectionMobile}>
            <Box className={classes.rootMobile}>
              <Box elevation={0} className={classes.itemMobile}>
                <Box className={classes.imgNameMobile} onClick={handleOnClickProduct}>
                  ...
                  <Box className={classes.itemProductMobile}>
                    <Typography className={classes.productNameMobile}>
